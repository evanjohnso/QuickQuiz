...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    @Bind(R.id.email) AutoCompleteTextView mEmailEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fbAuthListener = createAuthListener();
    ...
    public void onStart() {
        super.onStart();
        firebaseAuth.addAuthStateListener(fbAuthListener);
    }
    ...
    public void onStop() {
        ...
        if (fbAuthListener != null) {
                firebaseAuth.removeAuthStateListener(fbAuthListener);
        }
    }
    private FirebaseAuth.AuthStateListener createAuthListener() {
        return new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    Intent intent = new Intent(LoginActivity.this, SelectPathActivity.class);
